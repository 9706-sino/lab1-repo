...
//The implementation of this function is clear on
//what the move function does, i.e provides direction of the cursor
//It provides a convenient way for the client in the manner
//that they just need to call one function (move) every time they need
//to move the cursor instead of calling the different functions(up,down...)
//This reduces errors
